                ...
                <form action="{{ route('users.update', $item->id) }}" class="w-full" method="post"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input placeholder="Username" type="text" value="{{ old('name') ?? $item->name }}"
                                name="name"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input placeholder="Email" type="text" value="{{ old('email') ?? $item->email }}"
                                name="email"
                                class="appearance-none block w-full bg-gray-200 text-grey-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name">
                        </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input placeholder="Address" type="text" value="{{ old('address') ?? $item->address }}"
                                name="address"
                                class="appearance-none block w-full bg-gray-200 text-grey-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name">
                        </div>
