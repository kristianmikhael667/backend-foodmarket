            ...
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    <div class="w-full md:w-1/6 px-4 mb-4 md:mb-0">
                        <img src="{{ $item->food->picturePath }}" class="w-full rounded" alt="picurepath.jpg">
                    </div>
                    <div class="w-full md:w-5/6 px-4 mb-4 md:mb-0">
                        <div class="flex flex-wrap mb-3">
                            <div class="w-2/6">
                                <div class="text-sm">Procuct Name</div>
                        ...
                        <div class="flex flex-wrap mb-3">
                            <div class="w-5/6">
                                ...
                                <div class="text-xl font-bold"><a href="{{ $item->payment_url }}">{{ $item->payment_url
                                        }}</a>
                                </div>
                            </div>
                            <div class="w-5/6">
                            ...
                            <div class="w-1/6">
                                ...
                                <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'ON_DELIVERED']) }}"
